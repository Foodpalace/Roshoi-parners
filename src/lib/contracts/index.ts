/**
 * Integration contracts for the Roshoi platform.
...
export type PromotionKind = "percent" | "fixed" | "item" | "bogo";
...
export type OrderSnapshotLine = {
  ...
  addons: { addonId: string; name: string; pricePaise: Paise }[];
...
export type VendorOrder = {
  ...
  prices: OrderPriceSnapshot;
  dataLabel: DataLabel;
  riderStatus: OrderState | null;
};

export type RiderDispatchTicket = {
  orderId: string;
  orderNumber: string;
  restaurantId: string;
  pickup: {
