...
export const bn: MessageTree = {
  ...
  promotions: {
    ...
    estimate:
      "দিনে {n} অর্ডারে এই অফার রেস্তোরাঁর আয় প্রায় {amount} কমাতে পারে। এটি একটি আনুমানিক হিসাব।",
    activate: "চালু",
    pause: "থামান",
    create: "নতুন অফার",
    percent: "শতাংশ ছাড়",
  ...
  assistant: {
    ...
    send: "জিজ্ঞাসা",
    disclaimer:
      "উত্তর শুধু এই রেস্তোরাঁর অনুমোদিত সংখ্যা থেকে। সহায়ক আর্থিক অঙ্ক তৈরি করবে না।",
    unavailable: "এই পরিবেশে AI সংযুক্ত নয়।",
    examples:
      "আজকের সেরা বিক্রি কোনগুলো?|কোন সময় সবচেয়ে ব্যস্ত?|আমার হিসাব বুঝিয়ে দিন।|কোন আইটেম প্রায়ই থাকে না?",
  },
  onboarding: {
