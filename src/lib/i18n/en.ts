export const en = {
  ...
  assistant: {
    ...
    send: "Ask",
    disclaimer:
      "Answers use only this restaurant’s authorised numbers. The assistant will not invent financial figures.",
    unavailable: "AI is not connected in this environment.",
    examples:
      "What were my best-selling items today?|Which hours were busiest?|Explain my settlement.|Which items are often unavailable?",
  },
  onboarding: {
...
export type MessageKeySource = typeof en;
